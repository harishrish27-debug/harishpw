...
// Login as user, add the product to the cart, provide the details and 
// click on checkout, click on Credit Card, provide the address and confirm the order, logout as user
test('', async ({ page }) => {
